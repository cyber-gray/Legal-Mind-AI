"""
Legal-Mind-AI Multi-Agent Orchestrator - Working Version
This version uses direct Azure OpenAI calls instead of Azure AI Agents API
"""
...
class LegalMindWorkingOrchestrator:
    """
    Working Legal-Mind-AI Orchestrator using direct Azure OpenAI
    Multi-agent legal analysis with group chat functionality
    """
...
async def main():
    """Main function to run the Working Legal-Mind-AI system."""
    try:
        print("🚀 Initializing Legal-Mind-AI Working System...")
        
        # Initialize the orchestrator
        orchestrator = LegalMindWorkingOrchestrator()
        
        print("✅ Legal-Mind-AI Working System ready!")
        ...
        logger.error(f"Failed to run Legal-Mind-AI Working System: {e}")
        print(f"\n❌ System Error: {e}")
